...
| T-005 | AIC/BIC finite-sample threshold corollaries | C-004 | T-004 plus explicit sample-size and parameter-count conditions | backlog | Formalize thresholds as conditional corollaries, not universal guarantees. |
...
| `formal/OCECM/AICBICThreshold.lean` | Home for finite-sample threshold statement shapes. | No universal model-selection theorem. |
