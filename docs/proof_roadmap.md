...
Use the existing 9 AM America/New_York heartbeat. Worktree: `/private/tmp/ocecm-proof-progress-20260909`; branch: `agent/general-context-proof-20260909`; main repository: `/Users/brendanlam/Documents/GitHub/Omitting-Context-in-Cognition`. Set explicit workdir. If the worktree disappears, locate the branch and restore an isolated checkout without overwriting main. Do not fall back to an older roadmap.
