...
| C-002 | Omitted context induces a marginal mixture over latent decision parameters. | theorem | in_progress | revised proof-review draft in `docs/omitted_context_mixture_lemma.md`; proof-critic disposition `REVISE`; PI decisions on A-009/A-010 pending | theorem section/SI only after the revised proof review and PI gate | approved_default | 2026-07-12 |
